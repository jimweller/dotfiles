...
claude_regular() {
    ...
    ~/.config/dotfiles/scripts/devcontainer.sh exec zsh -c "claude --dangerously-skip-permissions '$*'"
}
...
claude_assume() {
    ...
    ~/.config/dotfiles/scripts/devcontainer.sh exec zsh -c "assume bedrock && exec claude --dangerously-skip-permissions '$*'"
}
