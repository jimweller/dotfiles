# Generated by Powerlevel10k configuration wizard on 2023-12-20 at 10:04 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|k|helm|kubens|kns|kubectx|kctx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|cmctl|sparkctl|kops'
...
#  typeset -g "_p9k__segment_cond_${_p9k__prompt_side}[_p9k__segment_index]"='$commands[tofu]'
  typeset -g "_p9k__segment_cond_${_p9k__prompt_side}[_p9k__segment_index]"='$P9K_SUGGESTED_COMMAND =~ $POWERLEVEL9K_OPENTOFU_SHOW_ON_COMMAND'
}
