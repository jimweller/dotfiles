...
When fixing a bug caused by invalid data, adding validation at one place feels sufficient. But that single check can be bypassed by different code paths, refactoring, or mocks.

**Core principle:** Validate at every layer data passes through. Make the bug structurally impossible.

## Why Multiple Layers

Single validation: "the bug is fixed."
Multiple layers: "the bug is impossible."
...
Result: bug structurally impossible to reproduce.
