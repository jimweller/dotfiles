...
description: Reviews code for Performance. Subagent used by review-quick and review-full skills.
model: inherit
---
...
- If nothing is found, emit only `## Performance\nNo findings.`
- If the change does not touch performance-relevant code, emit `## Performance\nNo findings.`
