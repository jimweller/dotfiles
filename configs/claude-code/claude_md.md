...
Most writing needs the first two. They cover 30 of the 49 patterns below.
...
- "load-bearing". Banned outright, in every register, with no exemption and no exception. It is not a domain term and the domain-term carve-out below does not reach it. Say what the thing does: "the review gates the release", "deleting it breaks the build", "the clause carries the decision". [move 2]
