...
These are the styles and behaviors expected in model chat responses.
...
These are writing styles to use when writing human prose like README, confluence, jira comments, pull requests, documentation etc. They are authoring standards.
...
These language patterns are forbidden for ANY prose generated by the model; both chat responses and authoring. Delete and rewrite any of these:
