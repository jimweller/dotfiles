...
- Antidote to manage zsh plugins [antidote](https://github.com/mattmc3/antidote)
- [Awesome Zsh Plugins](https://github.com/unixorn/awesome-zsh-plugins?tab=readme-ov-file#plugins) replace oh-my-zsh for me
- Oh My Zsh (I use some omz plugins still) [ohmyzsh](https://github.com/ohmyzsh/ohmyzsh)
